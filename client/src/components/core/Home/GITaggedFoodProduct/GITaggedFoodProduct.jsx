...
export default function GITaggedFoodProduct() {
    ...
    useEffect(() => {
        getProductsByType("Food Product", 12)
            .then(setProducts)
            .catch(() => setProducts([]))
        ...
        return (
            <section className={styles.section}>
                <div className={styles.container}>
                    <div className={styles.header}>
                        <h2>GI Tagged Food Stuff Products</h2>
                        <p>No food products available yet.</p>
                    </div>
                </div>
            </section>
        );
        ...
        <section className={styles.section}>
            <div className={styles.container}>
                ...
                <div className={styles.header}>
                    <h2>GI Tagged Food Stuff Products</h2>
                    <p>
                        Discover India&apos;s finest GI-certified food products rooted in tradition. Grown in authentic regions known for their unique soil, climate, and expertise. Delivered worldwide with trust, traceability, and premium quality assurance.
                    </p>
                </div>
                                    ...
                                    <div key={product._id} className={styles.card}>
                                        ...
                                        <div className={styles.categoryTag}>
                                            ...
                                            <span className={styles.categoryLabel}>
                                                {product.category?.name || product.productType || "Food Product"}
                                            </span>
                                        </div>
